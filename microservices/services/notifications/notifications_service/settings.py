...
JAZZMIN_SETTINGS = {
    ...
    "site_brand": "الإشعارات - SmartJudi",
    "site_logo": None,
    "welcome_sign": "إدارة الإشعارات والرسائل",
    "copyright": "SmartJudi 2026",
    "search_model": ["notifications_app.Notification"],
    "topmenu_links": [
    ...
    "icons": {
        "notifications_app.Notification": "fas fa-bell",
