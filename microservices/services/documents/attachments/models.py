...
def attachment_upload_path(instance, filename):
    ...
    return os.path.join('attachments', f'lawsuit_{instance.lawsuit_id}', filename)
...
class Attachment(models.Model):
    ...
    def __str__(self):
        return f'{self.get_document_type_display()} - {self.lawsuit_case_number or self.lawsuit_id}'
