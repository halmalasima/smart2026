"""
Local file upload validators for documents-service.
Copied from smartju/smartju/validators.py to keep service independent.
"""
...
def validate_file_extension(value):
    """Reject files with dangerous or unsupported extensions."""
    import os
