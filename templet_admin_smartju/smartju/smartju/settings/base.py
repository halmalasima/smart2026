...
# Trust Replit's proxy domain (and any extra origins) for CSRF.
...
# Control panel branding & gateway
CP_BRAND = os.environ.get('CP_BRAND', 'لوحة تحكم SmartJudi')
CP_VERSION = '1.0.0'
CP_GATEWAY_URL = os.environ.get('CP_GATEWAY_URL', 'http://localhost:8000')
...
# Allow login by phone number OR username (UserProfile.phone_number)
AUTHENTICATION_BACKENDS = [
    'accounts.auth_backends.PhoneOrUsernameBackend',
